from .entities.User import User # Importar la clase User


class ModelUser(): # Clase para el modelo de usuario

    @classmethod # Método de clase
    def login(self, db, user): # Iniciar sesión
        try: # Intentar
    ...
    @classmethod # Método de clase
    def register(self, db, user): # Registrar usuario
        try: # Intentar
            cursor = db.connection.cursor() # Crear el cursor
    ...
    @classmethod
    def logout(self, db, user: User): # Cerrar sesión
        try: # Intentar
    ...
    @classmethod # Método de clase
    def get_user_by_id(self, db, user: User): # Traer usuario por id
