...
USE MASTER
GO DROP DATABASE IF EXISTS CoopeTaxi;
...
CREATE TABLE dbo.Socios (
    ...
    -- Id del estado civil del socio
    NumeroCuentaBancaria varchar(20) NOT NULL,
    -- Número de cuenta bancaria del socio
    IdTelefono int NOT NULL,
    -- Id del teléfono del socio
    IdTelefono2 int NOT NULL,
    -- Id del teléfono 2 del socio
...
CREATE TABLE dbo.Automoviles (
    IdAutomovil int NOT NULL IDENTITY(1, 1),
    -- Id del automóvil (autoincremental)
    IdSocio int NOT NULL,
    -- Id del socio que lo registra
    ...
    -- Cantidad de pasajeros del automóvil
    MarchamoActual int NOT NULL,
    -- Marchamo actual del automóvil
    PolizaSeguros int NOT NULL,
    -- Poliza de seguros del automóvil
...
CREATE TABLE dbo.Choferes (
    ...
    -- Id del chofer (autoincremental)
    IdAutomovil int NOT NULL,
    -- Id del automóvil que lo registra
    Identificacion varchar(20) NOT NULL,
...
CREATE TABLE dbo.Clientes (
    ...
    -- Id del cliente (autoincremental)
    Identificacion varchar(20) NOT NULL,
...
CREATE TABLE dbo.Provincia (
    ...
    -- Id de la provincia (autoincremental)
    Nombre varchar(50) NOT NULL,
...
CREATE TABLE dbo.Distrito (
    ...
    -- Id del distrito (autoincremental)
    Nombre varchar(50) NOT NULL,
    -- Nombre del distrito
    IdCanton int NOT NULL,
    -- Id del cantón al que pertenece
...
CREATE TABLE dbo.Direcciones (
    ...
    -- Id de la dirección (autoincremental)
    IdCliente int NOT NULL,
    -- Id del cliente al que pertenece
    IdDistrito int NOT NULL,
    -- Id del distrito a la que pertenece
...
CREATE TABLE dbo.Viajes (
    IdViaje int NOT NULL IDENTITY(1, 1),
    -- Id del viaje (autoincremental)
    ...
    IdAutomovil int NOT NULL,
    -- Id del automóvil que se utiliza en el viaje
    IdChofer int NOT NULL,
    -- Id del chofer que se utiliza en el viaje
    IdDireccion int NOT NULL,
    -- Id de la dirección donde se realiza el viaje
...
CREATE TABLE dbo.Calificaciones (
    ...
    -- Id de la calificación (autoincremental)
    IdViaje int NOT NULL,
    -- Id del viaje que se califica
    Estrellas int NOT NULL,
    -- Cantidad de estrellas que se le da al cliente
...
SELECT dbo.Viajes.IdViaje,
    ...
    dbo.Viajes.HoraInicio,
    dbo.Viajes.Kilometraje,
    dbo.Viajes.HoraFin,
    dbo.Automoviles.IdAutomovil,
    dbo.Choferes.Nombre AS NombreChofer,
    dbo.Calificaciones.Estrellas,
    dbo.Calificaciones.Observaciones,
    dbo.Direcciones.DireccionExacta,
    dbo.Distrito.Nombre AS NombreDistrito,
    dbo.Canton.Nombre AS NombreCanton,
    dbo.Provincia.Nombre AS NombreProvincia
FROM dbo.Viajes
...
SELECT dbo.Choferes.Nombre,
    COUNT(dbo.Viajes.IdViaje) AS CantidadViajes,
    SUM(dbo.Viajes.Kilometraje) AS TotalKilometros
FROM dbo.Viajes
    INNER JOIN dbo.Choferes ON dbo.Viajes.IdChofer = dbo.Choferes.IdChofer
