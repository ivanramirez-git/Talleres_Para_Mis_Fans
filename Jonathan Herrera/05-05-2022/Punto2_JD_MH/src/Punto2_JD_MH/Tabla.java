...
public class Tabla extends javax.swing.JFrame {
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        for (int i = 0; i < personas.size(); i++) {
            ...
            if (p.getCategoria().equals("M")) {
                ...
                if (mujerMasAlta == null) {
                    ...
                    if (p.getRam() > mujerMasAlta.getRam()) {
                        // La guardamos
                        mujerMasAlta = p;
                    }
                }
        ...
        for (int i = 0; i < personas.size(); i++) {
            ...
            if (p.getCategoria().equals("H")) {
                ...
                if (hombreMasBajo == null) {
                    ...
                    if (p.getRam() < hombreMasBajo.getRam()) {
                        // La guardamos
                        hombreMasBajo = p;
                    }
                }
        ...
        JOptionPane.showMessageDialog(this, "La mujer mas alta es " + mujerMasAlta.getNombre() + " con una altura de " + mujerMasAlta.getRam());
        JOptionPane.showMessageDialog(this, "El hombre mas bajo es " + hombreMasBajo.getNombre() + " con una altura de " + hombreMasBajo.getRam());
