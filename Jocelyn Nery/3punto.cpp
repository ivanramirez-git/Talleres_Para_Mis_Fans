...
void porcentajeConsonantes(char* mensaje){
    ...
    cout << "El porcentaje de consonantes es: " << (cantidadConsonantes * 100) / cantidadLetras << "%" << endl;
}
...
void ordenarCaracteres(char* mensaje){
    ...
    cout << "El mensaje ordenado es: " << mensaje << endl;
}
...
void cuantasPalabras(char* mensaje){
    ...
    cout << "La cantidad de palabras que inician y terminan con consonante es: " << cantidadPalabras << endl;
}
