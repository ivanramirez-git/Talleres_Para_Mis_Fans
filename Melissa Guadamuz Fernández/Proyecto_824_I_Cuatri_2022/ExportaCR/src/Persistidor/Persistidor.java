...
public class Persistidor {
    ...
    public static boolean guardarClientes(ArrayList<Cliente> clientes) {
        try {
            ...
            // System.out.println("Error al cargar Guardar clientes.. Creando una lista vacia");   
            return false;
        }
    }

    // Funcion que guarda los datos de una lista de exportaciones en un archivo binario
    public static boolean guardarExportaciones(ArrayList<Exportacion> exportaciones) {
        try {
            ...
            // System.out.println("Error al cargar Guardar exportaciones.. Creando una lista vacia");            
            return false;
        }
    }
    ...
    public static ArrayList<Cliente> cargarClientes() {
        try {
            ...
            // System.out.println("Error al cargar Clientes.. Creando una lista vacia");
            return null;
        }
    }

    // Funcion que carga los datos de una lista de exportaciones desde un archivo binario
    public static ArrayList<Exportacion> cargarExportaciones() {
        try {
            ObjectInputStream ois = new ObjectInputStream(new FileInputStream(EXPORTACIONES_APROBADAS));
            ArrayList<Exportacion> exportaciones = (ArrayList<Exportacion>) ois.readObject();
            ois.close();
            return exportaciones;
        } catch (IOException | ClassNotFoundException ex) {
            // System.out.println("Error al cargar exportaciones.. Creando una lista vacia");
            return null;
        }
    }
}
