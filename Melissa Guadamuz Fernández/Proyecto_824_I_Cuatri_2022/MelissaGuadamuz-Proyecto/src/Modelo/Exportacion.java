...
public class Exportacion implements Serializable {
    ...
    // Fecha de la cotización: Valor que almacena la fecha del día en que se realizó
    // la cotización, debe ser igual a la fecha de ejecución del programa.
    protected String fecha;
    // Kilogramos a exportar: Corresponde un valor en kilogramos que puede contener
    // decimales. El valor mínimo permitido es 1 Kilogramo.
    protected double kg;
    /*
     * Zona de la Exportación (9 Zonas):
     * - Nueva Inglaterra (Maine, Nuevo Hampshire, Vermont, Massachusetts,
     * Connecticut, Rhode Island).
     * - Atlántico Medio (Nueva York, Pensilvania, Nueva Jersey).
     * - Atlántico Sur (Maryland, Delaware, Virginia Occidental, Virginia, Carolina
     * del Norte, Carolina del Sur, Georgia, Florida).
     * - Centro Norte Oriental (Michigan, Wisconsin, Illinois, Indiana, Ohio) o
     ...
     * - Montaña (Montana, Idaho, Wyoming, Colorado, Utah, Nevada, Arizona, Nuevo
     * México).
     * - Pacífico (Alaska, Washington, Oregón, California, Hawái).
     */
    protected String zona;
    // Dirección de Entrega: Corresponde a una dirección física dentro de los EEUU
    // para donde se entregara la carga. La misma debe al menos tener 20 Caracteres
    // alfanuméricos, con la finalidad de ser lo más específico.
    ...
    // Método que modifica el identificador del cliente.
    ...
    // Método que retorna una cadena de caracteres con la información de la
    // cotización.
    @Override
    public String toString() {
        return "Cotización: " + " Id:" + id + ", Id Cliente: " + idCliente + ", Fecha: " + fecha + ", Kg: " + kg
                + ", Zona: " + zona + ", Direccion: " + direccion + ", Tipo de Servicio: " + getTipoServicio();
    }
    ...
    public String calcularExportacion() {
        // Dividir el total de kilogramos en toneladas y lo que sobre en libras y lo que
        // sobre en gramos.
        double toneladas;
        int ton = 0;
        double libras;
