...
public class OfDelays {
    ...
    public String toString() {
        ...
        sb.append(OfDelays.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("carrier");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OfDelays) == false) {
            return false;
        }
        OfDelays rhs = ((OfDelays) other);
        return (((((((this.lateAircraft == rhs.lateAircraft)||((this.lateAircraft!= null)&&this.lateAircraft.equals(rhs.lateAircraft)))&&((this.carrier == rhs.carrier)||((this.carrier!= null)&&this.carrier.equals(rhs.carrier))))&&((this.security == rhs.security)||((this.security!= null)&&this.security.equals(rhs.security))))&&((this.nationalAviationSystem == rhs.nationalAviationSystem)||((this.nationalAviationSystem!= null)&&this.nationalAviationSystem.equals(rhs.nationalAviationSystem))))&&((this.weather == rhs.weather)||((this.weather!= null)&&this.weather.equals(rhs.weather))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))));
    }
