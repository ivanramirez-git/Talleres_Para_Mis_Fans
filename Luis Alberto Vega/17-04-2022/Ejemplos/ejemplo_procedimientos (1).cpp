...
void estadisticas()
{
	...
	printf("\n\t *** Programa Calcula Salarios - Estadisticas ***");
	printf("\n\n Cantidad Personas Genero Masculino: %i", contadorm);
	printf("\n\n Salario Acumulado Genero Masculino: %.2f",acumuladorm);
	printf("\n\n Promedio Salario  Genero Masculino: %.2f",promediom);
	printf("\n\n Cantidad Personas Genero Femenino.: %i", contadorf);
	printf("\n\n Salario Acumulado Genero Femenino.: %.2f",acumuladorf);
	printf("\n\n Promedio Salario  Genero Femenino.: %.2f",promediof);
